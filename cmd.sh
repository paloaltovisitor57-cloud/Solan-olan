#!/usr/bin/env bash
# Send a command to the running service (headless manual confirmation or emergency stop).
...
#           ./cmd.sh kill     autonomous: stop buys AND sells now      ./cmd.sh resume   lift it
#           ./cmd.sh disarm   autonomous: stop new buys (exits continue)
